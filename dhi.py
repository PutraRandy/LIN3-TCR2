...
cl = TOBY.LINE()
cl.login(token="EmKJnhmDwE6gpustkqW5.nqZhqiZgZilGvU4eyth5jq.Z6HzLjxi0pchJQrpYJrKR4pMqtnx79pzV4cAPpkKqlU=")
...
=> Bonds say = Mengikuti Apa Yang DiKatakan
...
=> Tagall/Sun/Mau = Tag Semua Member
...
admin=["u350cc7408cc6cc82e056ee046131f925","u350cc7408cc6cc82e056ee046131f925"]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~bonds1988",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~bonds1988",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
            elif msg.text in ["Tagall","Sun","Mau"]:
              if msg.from_ in admin:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Siap Ndan!!")
#-----------------------------------------------
            elif "Bonds say " in msg.text:
					bctxt = msg.text.replace("Bonds say ","")
...
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Assalammualaikum"]:
				ki.sendText(msg.to,"Sayang 魛渷魛厰Har Har魪靠")
				kk.sendText(msg.to,"Mojok 魛渷魛厰Har Har魪靠")
				kc.sendText(msg.to,"Yuuk 魛渷魛厰Har Har魪靠")
#-----------------------------------------------
            elif msg.text in ["Responsename","responsename"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Bonds🌎")
#-----------------------------------------------
			...
			for zx in range(0,500):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by @BONDSKILLER")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line://ti/p/bonds1988")
						print "DiLike"
					except:
							pass
				else:
