...
=> Dhi say = Mengikuti Apa Yang DiKatakan
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~boy29putra",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~boy29putra",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
            elif "dhi say " in msg.text:
					bctxt = msg.text.replace("Dhi say ","")
...
#-----------------------------------------------
           ...
           # elif "Mimic:" in msg.text:
            		...
            		#if "add" in cmd
            			#target = msg.text.replace("Mimic:add:","")
            			#target = target0.lstrip()
            			#target = target1.replace("@","")
            			#target = target2.rstrip()
            			#_name = target
            			#gInfo = cl.getGroup(msg.to)
            			#targets = []
